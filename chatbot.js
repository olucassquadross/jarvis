            ...
            379: (t) => {
                ...
                function r(t, r) {
                    for (var i = {}, a = [], c = 0; c < t.length; c++) {
                        ...
                        if (-1 !== d) n[d].references++, n[d].updater(f);
                            ...
                            var h = o(f, r);
                            (r.byIndex = c), n.splice(c, 0, { identifier: p, updater: h, references: 1 });
                        }
                        a.push(p);
                    }
                    return a;
                ...
                t.exports = function (t, o) {
                    ...
                    return function (t) {
                        ...
                        for (var l = r(t, o), s = 0; s < i.length; s++) {
                            var u = e(i[s]);
    ...
    (e.n = (t) => {
        ...
        (() => {
            var t = e(379),
                ...
                f = e(815),
                h = {};
            (h.styleTagTransform = d()), (h.setAttributes = l()), (h.insert = a().bind(null, "head")), (h.domAPI = o()), (h.insertStyleElement = u()), n()(f.Z, h);
            const m = f.Z && f.Z.locals ? f.Z.locals : void 0;
            var y = e(402),
                g = {};
            (g.styleTagTransform = d()), (g.setAttributes = l()), (g.insert = a().bind(null, "head")), (g.domAPI = o()), (g.insertStyleElement = u()), n()(y.Z, g);
            const v = y.Z && y.Z.locals ? y.Z.locals : void 0;
            function b(t) {
                return (
                    (b =
                        ...
                        if (null != e) {
                            ...
                            try {
                                if (((i = (e = e.call(t)).next), 0 === n)) {
                                    ...
                                    l = !1;
                                } else for (; !(l = (r = i.call(e)).done) && (c.push(r.value), c.length !== n); l = !0);
                            } catch (t) {
                                (s = !0), (o = t);
                            } finally {
                                try {
            ...
            var k = wp.element,
                ...
                O = function (t) {
                    ...
                    return (
                        C((n = { display: "inline-block", width: "16px" }), "display", "flex"),
                        C(n, "alignItems", "center"),
                        C(n, "justifyContent", "center"),
                        C(n, "animation", e ? "pulse 2s infinite" : ""),
                        C(n, "WebkitAnimation", e ? "pulse 2s infinite" : ""),
                        React.createElement(
                            "div",
                            R({ active: e ? "true" : "false", disabled: r }, o),
                        ...
                        modCss: I(
                            function () {
                                return function (n, e) {
                                    var r = m;
                                    return (
                                        (t && "none" !== t.themeId && "css" !== t.type) || (r = null),
                                        "messages" === (null == t ? void 0 : t.themeId) && (r = v),
                                        Array.isArray(n) || (n = [n]),
                                        e &&
                                        ...
                                        n
                                            .map(function (n) {
                                                ...
                                                return r
                                                    ? r[n]
                                                        ? "".concat(n, " ").concat(r[n])
                                                        : (console.warn('The class name "'.concat(n, '" is not defined in the "').concat(null !== (e = null == t ? void 0 : t.themeId) && void 0 !== e ? e : "N/A", '" theme.')), n)
                                                    : n;
                                            })
                                            .join(" ")
                                    );
                    ...
                    l(t, n, r) {
                        ...
                        return {
                            p: c.map(function (t, e) {
                                const o = i.exec(t)[0].length,
                                    a = new RegExp("^ {1," + o + "}", "gm"),
                                    s = t.replace(a, "").replace(i, ""),
                                    u = e === c.length - 1,
                                    p = -1 !== s.indexOf("\n\n") || (u && l);
                                l = p;
                                const d = r._,
                                    f = r.o;
                                let h;
                                (r.o = !0), p ? ((r._ = !1), (h = s.replace(Bt, "\n\n"))) : ((r._ = !0), (h = s.replace(Bt, "")));
                                const m = n(h, r);
                                return (r._ = d), (r.o = f), m;
                            }),
                            m: e,
                            g: a,
                        };
            ...
            const Jt = /^\[([^\]]*)]\( *((?:\([^)]*\)|[^() ])*) *"?([^)"]*)?"?\)/,
                $t = /^!\[([^\]]*)]\( *((?:\([^)]*\)|[^() ])*) *"?([^)"]*)?"?\)/,
                tn = [_, q, F, nt, et, it, ft, qt, Gt, Ft, Ut],
                nn = [...tn, /^[^\n]+(?:  \n|\n{2,})/, rt, ct];
            function en(t) {
                return t
            ...
            function rn(t) {
                return kt.test(t) ? "right" : Rt.test(t) ? "center" : Ct.test(t) ? "left" : null;
            }
            function on(t, n, e) {
                const r = e.v;
                e.v = !0;
                ...
                return (
                    o.forEach(function (t, n) {
                        "tableSeparator" === t.type ? 0 !== n && n !== o.length - 1 && i.push([]) : ("text" !== t.type || (null != o[n + 1] && "tableSeparator" !== o[n + 1].type) || (t.$ = t.$.replace(jt, "")), i[i.length - 1].push(t));
                    }),
                    i
                );
            }
            function an(t, n, e) {
                ...
                return (e._ = !1), { S: o, A: i, L: r, type: "table" };
            }
            function cn(t, n) {
            ...
            var Rn;
            function Cn(t, n = {}) {
                (n.overrides = n.overrides || {}), (n.slugify = n.slugify || en), (n.namedCodesToUnicode = n.namedCodesToUnicode ? T({}, Z, n.namedCodesToUnicode) : Z);
                const e = n.createElement || N.createElement;
                function r(t, r, ...o) {
                    const i = jn(n.overrides, `${t}.props`, {});
                    return e(
                        (function (t, n) {
                            const e = jn(n, t);
                            return e ? ("function" == typeof e || ("object" == typeof e && "render" in e) ? e : jn(n, `${t}.component`, t)) : t;
                        })(t, n.overrides),
                        T({}, r, i, { className: xn(null == r ? void 0 : r.className, i.className) || void 0 }),
                        ...o
                    );
                }
                function o(t) {
                    let e = !1;
                    n.forceInline ? (e = !0) : n.forceBlock || (e = !1 === vt.test(t));
                    const o = u(s(e ? t : `${t.trimEnd().replace(Vt, "")}\n\n`, { _: e }));
                    for (; "string" == typeof o[o.length - 1] && !o[o.length - 1].trim(); ) o.pop();
                    if (null === n.wrapper) return o;
                    const i = n.wrapper || (e ? "span" : "div");
                    let a;
                    if (o.length > 1 || n.forceWrapper) a = o;
                    else {
                        if (1 === o.length) return (a = o[0]), "string" == typeof a ? r("span", { key: "outer" }, a) : a;
                        a = null;
                    }
                    return N.createElement(i, { key: "outer" }, a);
                }
                function i(t) {
                    const n = t.match(M);
                    return n
                        ? n.reduce(function (t, n, e) {
                              const r = n.indexOf("=");
                              if (-1 !== r) {
                                  const i = (function (t) {
                                          return (
                                      ...
                                      l = (t[c] = (function (t, n) {
                                          return "style" === t
                                              ...
                                              : "href" === t
                                              ? fn(n)
                                              : (n.match(lt) && (n = n.slice(1, n.length - 1)), "true" === n || ("false" !== n && n));
                                      })(i, a));
                                  "string" == typeof l && (rt.test(l) || ct.test(l)) && (t[c] = N.cloneElement(o(l.trim()), { key: e }));
                              } else "style" !== n && (t[H[n] || n] = !0);
                              return t;
                          }, {})
                        : null;
                }
                const a = [],
                    c = {},
                    l = {
                        blockQuote: { t: un(_), i: Rn.HIGH, l: (t, n, e) => ({ $: n(t[0].replace(D, ""), e) }), h: (t, n, e) => r("blockquote", { key: e.k }, n(t.$, e)) },
                        breakLine: { t: pn(Q), i: Rn.HIGH, l: bn, h: (t, n, e) => r("br", { key: e.k }) },
                        breakThematic: { t: un(z), i: Rn.HIGH, l: bn, h: (t, n, e) => r("hr", { key: e.k }) },
                        codeBlock: {
                            t: un(F),
                            i: Rn.MAX,
                            l: (t) => ({ $: t[0].replace(/^ {4}/gm, "").replace(/\n+$/, ""), M: void 0 }),
                            h: (t, n, e) => r("pre", { key: e.k }, r("code", T({}, t.I, { className: t.M ? `lang-${t.M}` : "" }), t.$)),
                        },
                        codeFenced: { t: un(q), i: Rn.MAX, l: (t) => ({ I: i(t[3] || ""), $: t[4], M: t[2] || void 0, type: "codeBlock" }) },
                        codeInline: { t: sn(Y), i: Rn.LOW, l: (t) => ({ $: t[2] }), h: (t, n, e) => r("code", { key: e.k }, t.$) },
                        footnote: { t: un(K), i: Rn.MAX, l: (t) => (a.push({ O: t[2], B: t[1] }), {}), h: wn },
                        footnoteReference: { t: ln(J), i: Rn.HIGH, l: (t) => ({ $: t[1], R: `#${n.slugify(t[1])}` }), h: (t, n, e) => r("a", { key: e.k, href: fn(t.R) }, r("sup", { key: e.k }, t.$)) },
                        gfmTask: { t: ln(tt), i: Rn.HIGH, l: (t) => ({ T: "x" === t[1].toLowerCase() }), h: (t, n, e) => r("input", { checked: t.T, key: e.k, readOnly: !0, type: "checkbox" }) },
                        heading: { t: un(nt), i: Rn.HIGH, l: (t, e, r) => ({ $: mn(e, t[2], r), j: n.slugify(t[2]), C: t[1].length }), h: (t, n, e) => r(`h${t.C}`, { id: t.j, key: e.k }, n(t.$, e)) },
                        headingSetext: { t: un(et), i: Rn.MAX, l: (t, n, e) => ({ $: mn(n, t[1], e), C: "=" === t[2] ? 1 : 2, type: "heading" }) },
                        htmlComment: { t: pn(it), i: Rn.HIGH, l: () => ({}), h: wn },
                        image: { t: sn($t), i: Rn.HIGH, l: (t) => ({ D: t[1], R: hn(t[2]), N: t[3] }), h: (t, n, e) => r("img", { key: e.k, alt: t.D || void 0, title: t.N || void 0, src: fn(t.R) }) },
                        link: { t: ln(Jt), i: Rn.LOW, l: (t, n, e) => ({ $: yn(n, t[1], e), R: hn(t[2]), N: t[3] }), h: (t, n, e) => r("a", { key: e.k, href: fn(t.R), title: t.N }, n(t.$, e)) },
                        linkAngleBraceStyleDetector: { t: ln(pt), i: Rn.MAX, l: (t) => ({ $: [{ $: t[1], type: "text" }], R: t[1], type: "link" }) },
                        linkBareUrlDetector: { t: (t, n) => (n.Z ? null : ln(st)(t, n)), i: Rn.MAX, l: (t) => ({ $: [{ $: t[1], type: "text" }], R: t[1], N: void 0, type: "link" }) },
                        linkMailtoDetector: {
                            t: ln(ut),
                            i: Rn.MAX,
                            l(t) {
                                let n = t[1],
                                    e = t[1];
                                return P.test(e) || (e = "mailto:" + e), { $: [{ $: n.replace("mailto:", ""), type: "text" }], R: e, type: "link" };
                            },
                        },
                        orderedList: Kt(r, 1),
                        unorderedList: Kt(r, 2),
                        newlineCoalescer: { t: un(G), i: Rn.LOW, l: bn, h: () => "\n" },
                        paragraph: { t: dn, i: Rn.LOW, l: vn, h: (t, n, e) => r("p", { key: e.k }, n(t.$, e)) },
                        ref: { t: ln(ht), i: Rn.MAX, l: (t) => ((c[t[1]] = { R: t[2], N: t[4] }), {}), h: wn },
                        refImage: { t: sn(mt), i: Rn.MAX, l: (t) => ({ D: t[1] || void 0, F: t[2] }), h: (t, n, e) => r("img", { key: e.k, alt: t.D, src: fn(c[t.F].R), title: c[t.F].N }) },
                        refLink: {
                            t: ln(yt),
                            i: Rn.MAX,
                            l: (t, n, e) => ({ $: n(t[1], e), P: n(t[0].replace(gt, "\\$1"), e), F: t[2] }),
                            h: (t, n, e) => (c[t.F] ? r("a", { key: e.k, href: fn(c[t.F].R), title: c[t.F].N }, n(t.$, e)) : r("span", { key: e.k }, n(t.P, e))),
                        },
                        table: {
                            t: un(ft),
                            i: Rn.HIGH,
                                ...
                                r(
                                    ...
                                    r(
                                        ...
                                        r(
                                            "tr",
                                            null,
                                            t.L.map(function (o, i) {
                                                return r("th", { key: i, style: cn(t, i) }, n(o, e));
                                            })
                                        )
                                    ),
                                    r(
                                        "tbody",
                                        null,
                                        t.A.map(function (o, i) {
                                            return r(
                                                "tr",
                                                { key: i },
                                                o.map(function (o, i) {
                                                    return r("td", { key: i, style: cn(t, i) }, n(o, e));
                                                })
                                            );
                                        })
                                    )
                        ...
                        text: { t: pn(At), i: Rn.MIN, l: (t) => ({ $: t[0].replace(ot, (t, e) => (n.namedCodesToUnicode[e] ? n.namedCodesToUnicode[e] : t)) }), h: (t) => t.$ },
                        textBolded: { t: sn(St), i: Rn.MED, l: (t, n, e) => ({ $: n(t[2], e) }), h: (t, n, e) => r("strong", { key: e.k }, n(t.$, e)) },
                        textEmphasized: { t: sn(It), i: Rn.LOW, l: (t, n, e) => ({ $: n(t[2], e) }), h: (t, n, e) => r("em", { key: e.k }, n(t.$, e)) },
                        textEscaped: { t: sn(Ot), i: Rn.HIGH, l: (t) => ({ $: t[1], type: "text" }) },
                        textMarked: { t: sn(Lt), i: Rn.LOW, l: vn, h: (t, n, e) => r("mark", { key: e.k }, n(t.$, e)) },
                        textStrikethroughed: { t: sn(Et), i: Rn.LOW, l: vn, h: (t, n, e) => r("del", { key: e.k }, n(t.$, e)) },
                    };
                !0 !== n.disableParsingRawHTML &&
                    ((l.htmlBlock = {
                        t: pn(rt),
                        i: Rn.HIGH,
                        l(t, n, e) {
                            const [, r] = t[3].match(Nt),
                                o = new RegExp(`^${r}`, "gm"),
                                a = t[3].replace(o, ""),
                                c = ((l = a), nn.some((t) => t.test(l)) ? gn : mn);
                            var l;
                            const s = t[1].toLowerCase(),
                                u = -1 !== X.indexOf(s);
                            e.Z = e.Z || "a" === s;
                            const p = u ? t[3] : c(n, a, e);
                            return (e.Z = !1), { I: i(t[2]), $: p, G: u, H: u ? s : t[1] };
                        },
                        h: (t, n, e) => r(t.H, T({ key: e.k }, t.I), t.G ? t.$ : n(t.$, e)),
                    }),
                    (l.htmlSelfClosing = { t: pn(ct), i: Rn.HIGH, l: (t) => ({ I: i(t[2] || ""), H: t[1] }), h: (t, n, e) => r(t.H, T({}, t.I, { key: e.k })) }));
                const s = (function (t) {
                        let n = Object.keys(t);
                        function e(r, o) {
                            let i = [],
                            ...
                            for (; r; ) {
                                ...
                                for (; c < n.length; ) {
                                    ...
                                    if (u) {
                                        ...
                                        const n = s.l(u, e, o);
                                        null == n.type && (n.type = l), i.push(n), (a = t);
                                        break;
                                    }
                                    c++;
                                }
                        ...
                        function t(n, e = {}) {
                            if (Array.isArray(n)) {
                                ...
                                for (let r = 0; r < n.length; r++) {
                                    ...
                                    const a = t(n[r], e),
                                        c = "string" == typeof a;
                                    c && i ? (o[o.length - 1] += a) : null !== a && o.push(a), (i = c);
                                }
                                return (e.k = r), o;
                            }
                            return p(n, t, e);
                ...
                return a.length
                    ? r(
                          ...
                          r(
                              ...
                              { key: "footer" },
                              a.map(function (t) {
                                  return r("div", { id: n.slugify(t.B), key: t.B }, t.B, u(s(t.O, { _: !0 })));
                              })
                          )
                      )
                    : d;
            ...
            const kn = (t) => {
                ...
                return N.cloneElement(Cn(n, e), r);
            };
            function Sn() {
                Sn = function () {
                    return t;
                ...
                function s(t, n, e, o) {
                    var i = n && n.prototype instanceof d ? n : d,
                        ...
                        c = new k(o || []);
                    return r(a, "_invoke", { value: x(t, e, c) }), a;
                }
                function u(t, n, e) {
                    try {
                ...
                function w(t, n) {
                    function o(r, i, a, c) {
                        ...
                        if ("throw" !== l.type) {
                            var s = l.arg,
                                p = s.value;
                            return p && "object" == On(p) && e.call(p, "__await")
                ...
                function x(t, n, e) {
                    ...
                    return function (o, i) {
                        ...
                        for (e.method = o, e.arg = i; ; ) {
                            ...
                            var l = u(t, n, e);
                            if ("normal" === l.type) {
                                if (((r = e.done ? "completed" : "suspendedYield"), l.arg === p)) continue;
                                return { value: l.arg, done: e.done };
                            }
                            "throw" === l.type && ((r = "completed"), (e.method = "throw"), (e.arg = l.arg));
                        }
                    };
                }
                function j(t, n) {
                    ...
                    if (void 0 === r)
                        return (
                            (n.delegate = null),
                            ("throw" === e && t.iterator.return && ((n.method = "return"), (n.arg = void 0), j(t, n), "throw" === n.method)) ||
                ...
                return (
                    ...
                    (t.mark = function (t) {
                        return Object.setPrototypeOf ? Object.setPrototypeOf(t, h) : ((t.__proto__ = h), l(t, c, "GeneratorFunction")), (t.prototype = Object.create(v)), t;
                    }),
                    (t.awrap = function (t) {
                        return { __await: t };
                    }),
                    ...
                    (k.prototype = {
                        ...
                        delegateYield: function (t, n, e) {
                            return (this.delegate = { iterator: S(t), resultName: n, nextLoc: e }), "next" === this.method && (this.arg = void 0), p;
                        },
                    }),
                    t
                );
            ...
            var An = wp.element,
                Vn = (An.useMemo, An.useEffect),
                Nn = An.useState,
                Tn = function () {
                    var t = new WeakSet();
                    return function (n, e) {
                        if ("object" === On(e) && null !== e) {
                            if (t.has(e)) throw new Error("Circular reference found. Cancelled.", { key: n, value: e });
                            t.add(e);
                        }
                        return e;
                    };
                                ...
                                function (t) {
                                    for (;;)
                                        switch ((t.prev = t.next)) {
                                            case 0:
                                                if (((r = g.length > 2 && void 0 !== g[2] ? g[2] : null), e)) {
                                                    t.next = 14;
                                                    break;
                                                }
                                                return (t.prev = 2), (t.next = 5), n.json();
                                            case 5:
                                                return (o = t.sent), r && console.log("[".concat(r, "] IN: "), o), t.abrupt("return", o);
                                            case 10:
                                                return (
                                                    (t.prev = 10),
                                                    (t.t0 = t.catch(2)),
                                                    console.error("Could not parse the regular response.", { err: t.t0, data }),
                                                    t.abrupt("return", { success: !1, message: "Could not parse the regular response." })
                                                );
                                            case 14:
                                                (i = n.body.getReader()), (a = new TextDecoder("utf-8")), (c = ""), (l = "");
                                            case 18:
                                                return (t.next = 21), i.read();
                                            case 21:
                                                if (((s = t.sent), (u = s.value), (p = s.done), (c += a.decode(u, { stream: !0 })), !p)) {
                                                    t.next = 27;
                                                    break;
                                                }
                                                return t.abrupt("break", 68);
                                            case 27:
                                                (d = c.split("\n")), (f = 0);
                                            case 29:
                                                if (!(f < d.length - 1)) {
                                            ...
                                            case 32:
                                                if ("live" !== (h = JSON.parse(d[f].replace("data: ", ""))).type) {
                                                    t.next = 39;
                                                    break;
                                                }
                                                r && console.log("[".concat(r, " STREAM] LIVE: "), h), (l += h.data), e && e(l, h.data), (t.next = 62);
                                                break;
                                            case 39:
                                                if ("error" !== h.type) {
                                                    t.next = 51;
                                                ...
                                                return (t.prev = 40), r && console.error("[".concat(r, " STREAM] ERROR: "), h.data), t.abrupt("return", { success: !1, message: h.data });
                                            case 45:
                                                return (
                                                    (t.prev = 45),
                                                    (t.t1 = t.catch(40)),
                                                    console.error("Could not parse the 'error' stream.", { err: t.t1, data: h }),
                                                    t.abrupt("return", { success: !1, message: "Could not parse the 'error' stream." })
                                                );
                                            case 49:
                                                t.next = 62;
                                                break;
                                            case 51:
                                                ...
                                                return (t.prev = 52), (m = JSON.parse(h.data)), r && console.log("[".concat(r, " STREAM] END: "), m), t.abrupt("return", m);
                                            case 58:
                                                return (
                                                    (t.prev = 58),
                                                    (t.t2 = t.catch(52)),
                                                    console.error("Could not parse the 'end' stream.", { err: t.t2, data: h }),
                                                    t.abrupt("return", { success: !1, message: "Could not parse the 'end' stream." })
                                                );
                                            case 62:
                                                f++, (t.next = 29);
                                                break;
                                            case 65:
                                                (c = d[d.length - 1]), (t.next = 18);
                                                break;
                                            case 68:
                                                return (t.prev = 68), (y = JSON.parse(c)), r && console.log("[".concat(r, " STREAM] IN: "), y), t.abrupt("return", y);
                                            case 74:
                                                return (t.prev = 74), (t.t3 = t.catch(68)), console.error("Could not parse the buffer.", { err: t.t3, buffer: c }), t.abrupt("return", { success: !1, message: "Could not parse the buffer." });
                                            case 78:
                                            case "end":
                                                return t.stop();
                                        }
                                ...
                                switch ((t.prev = t.next)) {
                                    case 0:
                                        return (
                                            ...
                                            (t.next = 5),
                                            fetch("".concat(n), { method: "POST", headers: i, body: JSON.stringify(e, Tn()) })
                                        );
                                    case 5:
            ...
            var Pn = function () {
                        ...
                        return (
                            ...
                            (function (t, n) {
                                if (t) {
                                    ...
                                    var e = Object.prototype.toString.call(t).slice(8, -1);
                                    return (
                                        "Object" === e && t.constructor && (e = t.constructor.name), "Map" === e || "Set" === e ? Array.from(t) : "Arguments" === e || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(e) ? In(t, n) : void 0
                                    );
                                }
                            })(t, n) ||
                            (function () {
                ...
                var r = { opacity: n ? 1 : 0, width: "1px", height: "1em", borderLeft: "8px solid", marginLeft: "2px" };
                return React.createElement("span", { style: r });
            };
            function Wn(t) {
                return (
                    (Wn =
            ...
            function Qn(t) {
                for (var n = 1; n < arguments.length; n++) {
                    ...
                    n % 2
                        ? Dn(Object(e), !0).forEach(function (n) {
                              zn(t, n, e[n]);
                          })
                        : Object.getOwnPropertyDescriptors
                        ? Object.defineProperties(t, Object.getOwnPropertyDescriptors(e))
                        : Dn(Object(e)).forEach(function (n) {
                ...
                function w(t, n) {
                    function o(r, i, a, c) {
                        ...
                        if ("throw" !== l.type) {
                            var s = l.arg,
                                p = s.value;
                            return p && "object" == Wn(p) && e.call(p, "__await")
                                ? n.resolve(p.__await).then(
                                      function (t) {
                                          o("next", t, a, c);
                                      },
            ...
            function Kn(t, n) {
                if (t) {
                    if ("string" == typeof t) return Jn(t, n);
                    var e = Object.prototype.toString.call(t).slice(8, -1);
                    return "Object" === e && t.constructor && (e = t.constructor.name), "Map" === e || "Set" === e ? Array.from(t) : "Arguments" === e || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(e) ? Jn(t, n) : void 0;
                }
            }
            function Jn(t, n) {
                (null == n || n > t.length) && (n = t.length);
            ...
            var $n = wp.element,
                ...
                le = function () {
                    var t = te(ce);
                    if (!t) throw new Error("useChatbotContext must be used within a ChatbotContextProvider");
                    return t;
                },
                se = function (t) {
                    var n,
                        ...
                        P = s.restUrl,
                        W = s.debugMode,
                        _ = null !== (n = null == s ? void 0 : s.typewriter) && void 0 !== n && n,
                        D = null !== (e = null == s ? void 0 : s.speech_recognition) && void 0 !== e && e,
                        Q = null !== (r = null == s ? void 0 : s.speech_synthesis) && void 0 !== r && r,
                        z = null !== (o = null === (i = l.startSentence) || void 0 === i ? void 0 : i.trim()) && void 0 !== o ? o : "",
                        q = (function (t) {
                            var n,
                                e,
                                r,
                                ...
                                x,
                                j,
                                R = null !== (n = null === (e = t.guestName) || void 0 === e ? void 0 : e.trim()) && void 0 !== n ? n : "",
                                C = null !== (r = null === (o = t.textSend) || void 0 === o ? void 0 : o.trim()) && void 0 !== r ? r : "",
                                k = null !== (i = null === (a = t.textClear) || void 0 === a ? void 0 : a.trim()) && void 0 !== i ? i : "",
                                S = parseInt(t.textInputMaxLength),
                                I = null !== (c = null === (l = t.textInputPlaceholder) || void 0 === l ? void 0 : l.trim()) && void 0 !== c ? c : "",
                                L = null !== (s = null === (u = t.textCompliance) || void 0 === u ? void 0 : u.trim()) && void 0 !== s ? s : "",
                                E = Boolean(t.window),
                                O = Boolean(t.copyButton),
                                A = Boolean(t.fullscreen),
                                V = null !== (p = null === (d = t.icon) || void 0 === d ? void 0 : d.trim()) && void 0 !== p ? p : "",
                                N = null !== (f = null === (h = t.iconText) || void 0 === h ? void 0 : h.trim()) && void 0 !== f ? f : "",
                                T = null !== (m = null === (y = t.iconAlt) || void 0 === y ? void 0 : y.trim()) && void 0 !== m ? m : "",
                                B = null !== (g = null === (v = t.iconPosition) || void 0 === v ? void 0 : v.trim()) && void 0 !== g ? g : "",
                                H = null !== (b = null === (w = t.aiName) || void 0 === w ? void 0 : w.trim()) && void 0 !== b ? b : "",
                                Z = null !== (x = null === (j = t.userName) || void 0 === j ? void 0 : j.trim()) && void 0 !== x ? x : "";
                            return {
                                textSend: C,
                                textClear: k,
                                ...
                                copyButton: O,
                                fullscreen: A,
                                localMemory: Boolean(t.localMemory),
                                icon: V,
                                iconText: N,
                                iconAlt: T,
                                iconPosition: B,
                        ...
                        F = q.textSend,
                        Y = q.textClear,
                        G = q.textInputMaxLength,
                        U = q.textInputPlaceholder,
                        K = q.textCompliance,
                        J = q.aiName,
                        $ = q.userName,
                        tt = q.guestName,
                        ...
                        lt = q.iconPosition,
                        st = ot && (!!O || !!T),
                        ut = st ? "mwai-chat-".concat(O || T) : null,
                        pt = re(
                            function () {
                                var t = it ? (V(it) ? it : M + "/images/" + it) : M + "/images/chat-green.svg";
                                return {
                                    cssVariables: Object.keys(f).reduce(function (t, n) {
                                        return (t["--mwai-".concat(n)] = f[n]), t;
                                    }, {}),
                                    iconUrl: t,
                                };
                            },
                        ...
                        ft = pt.iconUrl;
                    (J = (function (t, n, e, r) {
                        if (t) t = V(t) ? React.createElement("div", { className: r("mwai-avatar") }, React.createElement("img", { src: t })) : React.createElement("div", { className: r("mwai-name-text") }, t);
                        else {
                            var o = e || "".concat(n, "/images/chat-openai.svg");
                            t = React.createElement("div", { className: r(["mwai-avatar"]) }, React.createElement("img", { src: "".concat(o) }));
                        }
                        return t;
                    })(J, M, ft, d)),
                        ($ = (function (t) {
                            var n = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : "Guest: ",
                            ...
                            return (
                                t
                                    ? V(t)
                                        ? (t = React.createElement("div", { className: o(["mwai-avatar"]) }, React.createElement("img", { src: t })))
                                        : ((t = (function (t) {
                                              var n = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : "Guest: ",
                                                  e = arguments.length > 2 ? arguments[2] : void 0;
                                              if (!e || 0 === Object.keys(e).length) return n;
                                              for (var r = 0, o = Object.entries(e); r < o.length; r++) {
                                                  var i = x(o[r], 2),
                                                      a = i[0],
                                                      c = i[1],
                                                      l = "{".concat(a, "}");
                                                  t.includes(l) && (t = t.replace(l, c));
                                              }
                                              return t || n || "Guest: ";
                                          })(t, n, e)),
                                          (t = React.createElement("div", { className: o(["mwai-name-text"]) }, t)))
                                    : (t = e
                                          ? React.createElement("div", { className: o(["mwai-avatar"]) }, React.createElement("img", { src: e.AVATAR_URL }))
                                          : React.createElement("div", { className: o(["mwai-avatar", "mwai-svg"]) }, React.createElement("img", { src: "".concat(r, "/images/avatar-user.svg") }))),
                                t
                            );
                        })($, tt, B, M, d)),
                        oe(
                    ...
                    var ht = function (t) {
                            ut && localStorage.setItem(ut, JSON.stringify({ clientId: v, messages: t }, Tn()));
                        },
                        mt = function () {
                            if (z) {
                                var t = [{ id: Mn(), role: "assistant", content: z, who: ae, timestamp: new Date().getTime() }];
                                y(t);
                            } else y([]);
                        },
                        yt = ie(
                            function () {
                                var t = [];
                                if (ut && (t = localStorage.getItem(ut))) return (t = JSON.parse(t)), y(t.messages), void b(t.clientId);
                                mt();
                            },
                            [T]
                        );
                        ...
                        oe(
                            function () {
                                if (L) {
                                    ...
                                    if (!L.success) return "assistant" === n.role && n.isQuerying && t.pop(), t.pop(), t.push({ id: Mn(), role: "system", content: L.message, who: ae, timestamp: new Date().getTime() }), y(t), void ht(t);
                                    if ("assistant" === n.role && n.isQuerying) (n.content = L.reply), L.images && (n.images = L.images), (n.timestamp = new Date().getTime()), delete n.isQuerying;
                                    else if ("assistant" === n.role && n.isStreaming) (n.content = L.reply), L.images && (n.images = L.images), (n.timestamp = new Date().getTime()), delete n.isStreaming;
                                    else {
                                        var e = { id: Mn(), role: "assistant", content: L.reply, who: ae, timestamp: new Date().getTime() };
                                        L.images && (e.images = L.images), t.push(e);
                                    }
                                    y(t), ht(t);
                                }
                            },
                    ...
                    var gt = ie(
                                ...
                                qn().mark(function t() {
                                    return qn().wrap(function (t) {
                                        for (;;)
                                            switch ((t.prev = t.next)) {
                                                case 0:
                                                    return (t.next = 2), b(Mn());
                                                case 2:
                                                    ut && localStorage.removeItem(ut), mt(), R("");
                                                case 5:
                                                case "end":
                                                    return t.stop();
                                            }
                                            ...
                                            for (;;)
                                                switch ((t.prev = t.next)) {
                                                    case 0:
                                                        ...
                                                        return console.error("AI Engine: There is already a query in progress."), t.abrupt("return");
                                                    case 3:
                                                        return (
                                                            "string" != typeof n && (n = j),
                                                            S(!0),
                                                            R(""),
                                                            (e = [].concat(Gn(m), [{ id: Mn(), role: "user", content: n, who: "User: ", timestamp: new Date().getTime() }])),
                                                            ht(e),
                                                            (r = Mn()),
                                                            (o = [].concat(Gn(e), [{ id: r, role: "assistant", content: null, who: ae, timestamp: null, isQuerying: !N, isStreaming: !!N }])),
                                                            y(o),
                                                            (i = Qn({ id: O, botId: T, session: H, clientId: v, contextId: Z, messages: m, newMessage: n, stream: N }, p)),
                                                            (t.prev = 12),
                                                            W && console.log("[CHATBOT] OUT: ", i),
                                                            (a = N
                                                                ? function (t) {
                                                                      y(function (n) {
                                                                          var e = Gn(n),
                                                                              o = e.length > 0 ? e[e.length - 1] : null;
                                                                          return o && o.id === r && ((o.content = t), (o.timestamp = new Date().getTime())), e;
                                                                      });
                                                                  }
                                                                : null),
                                                            (t.next = 17),
                                                            Zn("".concat(P, "/mwai-ui/v1/chats/submit"), i, X, N)
                                                        );
                                                    case 17:
                                                        return (c = t.sent), (t.next = 20), Bn(c, a, W ? "CHATBOT" : null);
                                                    case 20:
                                                        (l = t.sent), E(l), (t.next = 28);
                                                        break;
                                                    case 24:
                                                        (t.prev = 24), (t.t0 = t.catch(12)), console.error("An error happened in the handling of the chatbot response.", { err: t.t0 }), S(!1);
                                                    case 28:
                                                    case "end":
                                                        return t.stop();
                                                }
                        ...
                        bt = { setInputText: R, saveMessages: ht, initChatbot: yt, setMessages: y, setClientId: b, resetMessages: mt, onClear: gt, onSubmit: vt },
                        wt = {
                            botId: T,
                            userData: B,
                            pluginUrl: M,
                    ...
                    return React.createElement(ce.Provider, { value: { state: wt, actions: bt } }, a);
                };
            function ue() {
                return (
                    (ue = Object.assign
            ...
            var de = function (t, n) {
                "function" != typeof t ? (t.current = n) : t(n);
            };
            var fe = { "min-height": "0", "max-height": "none", height: "0", visibility: "hidden", overflow: "hidden", position: "absolute", "z-index": "-1000", top: "0", right: "0" },
                he = function (t) {
                    Object.keys(fe).forEach(function (n) {
                        t.style.setProperty(n, fe[n], "important");
                    });
                },
                me = null,
                ye = function (t, n) {
                    var e = t.scrollHeight;
                    return "border-box" === n.sizingStyle.boxSizing ? e + n.borderSize : e - n.paddingSize;
                },
                ge = function () {},
                ve = [
                    "borderBottomWidth",
                ...
                be = !!document.documentElement.currentStyle;
            function we(t, n, e) {
                var r,
                    o,
                    i =
            ...
            var xe = ["cacheMeasurements", "maxRows", "minRows", "onChange", "onHeightChange"],
                je = function (t, n) {
                    var e,
                        r = t.cacheMeasurements,
                        o = t.maxRows,
                        i = t.minRows,
                        a = t.onChange,
                        c = void 0 === a ? ge : a,
                        ...
                        f = (function (t, n) {
                            ...
                            return (0, N.useCallback)(
                                function (r) {
                                    (t.current = r), e.current && de(e.current, null), (e.current = n), n && de(n, r);
                                },
                                [n]
                            );
                        })(d, n),
                                    ...
                                    r && m.current
                                        ...
                                        : (function (t) {
                                              ...
                                              return "" === o
                                                  ...
                                                  : (be &&
                                                        "border-box" === o &&
                                                        (r.width = parseFloat(r.width) + parseFloat(r.borderRightWidth) + parseFloat(r.borderLeftWidth) + parseFloat(r.paddingRight) + parseFloat(r.paddingLeft) + "px"),
                                                    { sizingStyle: r, paddingSize: parseFloat(r.paddingBottom) + parseFloat(r.paddingTop), borderSize: parseFloat(r.borderBottomWidth) + parseFloat(r.borderTopWidth) });
                                          })(t);
                            if (n) {
                                m.current = n;
                                var e = (function (t, n, e, r) {
                                        void 0 === e && (e = 1),
                                            void 0 === r && (r = 1 / 0),
                                            me || ((me = document.createElement("textarea")).setAttribute("tabindex", "-1"), me.setAttribute("aria-hidden", "true"), he(me)),
                                            null === me.parentNode && document.body.appendChild(me);
                                        var o = t.paddingSize,
                                            i = t.borderSize,
                                            a = t.sizingStyle,
                                            c = a.boxSizing;
                                        Object.keys(a).forEach(function (t) {
                                            ...
                                            (me.value = n);
                                        var l = ye(me, t);
                                        (me.value = n), (l = ye(me, t)), (me.value = "x");
                                        var s = me.scrollHeight - o,
                                            u = s * e;
                                        "border-box" === c && (u = u + o + i), (l = Math.max(u, l));
                                        var p = s * r;
                                        return "border-box" === c && (p = p + o + i), [(l = Math.min(p, l)), s];
                                    })(n, t.value || t.placeholder || "x", i, o),
                                    a = e[0],
                                    c = e[1];
                                h.current !== a && ((h.current = a), t.style.setProperty("height", a + "px", "important"), s(a, { rowHeight: c }));
                            }
                        };
                    return (
                        (0, N.useLayoutEffect)(y),
                        we(window, "resize", y),
                        (e = y),
                        we(document.fonts, "loadingdone", e),
                        (0, N.createElement)(
                            "textarea",
                            ue({}, u, {
                                onChange: function (t) {
            ...
            var ke = {
                    ...
                    preStringTyped: function (t, n) {},
                    onStringTyped: function (t, n) {},
                    onLastStringBackspaced: function (t) {},
                    onTypingPaused: function (t, n) {},
                    onTypingResumed: function (t, n) {},
                    onReset: function (t) {},
                    onStop: function (t, n) {},
                ...
                Se = new ((function () {
                    ...
                    return (
                        (n.load = function (t, n, e) {
                            if (
                                ((t.el = "string" == typeof e ? document.querySelector(e) : e),
                                (t.options = Ce({}, ke, n)),
                                ...
                                var r = Array.prototype.slice.apply(t.stringsElement.children),
                                    o = r.length;
                                if (o) for (var i = 0; i < o; i += 1) t.strings.push(r[i].innerHTML.trim());
                            }
                        ...
                        (n.appendCursorAnimationCss = function (t) {
                            var n = "data-typed-js-cursor-css";
                            if (t.showCursor && !document.querySelector("[" + n + "]")) {
                        ...
                        (n.appendFadeOutAnimationCss = function (t) {
                            var n = "data-typed-fadeout-js-css";
                            if (t.fadeOut && !document.querySelector("[" + n + "]")) {
                                var e = document.createElement("style");
                                e.setAttribute(n, "true"),
                                    (e.innerHTML =
                ...
                Ie = new ((function () {
                    ...
                    var n = t.prototype;
                    return (
                        (n.typeHtmlChars = function (t, n, e) {
                            if ("html" !== e.contentType) return n;
                            var r = t.substring(n).charAt(0);
                            if ("<" === r || "&" === r) {
                                var o;
                                for (o = "<" === r ? ">" : ";"; t.substring(n + 1).charAt(0) !== o && !(1 + ++n > t.length); );
                                n++;
                            }
                            return n;
                        }),
                        (n.backSpaceHtmlChars = function (t, n, e) {
                            if ("html" !== e.contentType) return n;
                            var r = t.substring(n).charAt(0);
                            if (">" === r || ";" === r) {
                                var o;
                                for (o = ">" === r ? "<" : "&"; t.substring(n - 1).charAt(0) !== o && !(--n < 0); );
                                n--;
                            }
                            return n;
                        }),
                ...
                Le = (function () {
                    ...
                    return (
                        ...
                        (n.typewrite = function (t, n) {
                            ...
                            !0 !== this.pause.status
                                ? (this.timeout = setTimeout(function () {
                                      n = Ie.typeHtmlChars(t, n, e);
                                      var r = 0,
                                          i = t.substring(n);
                                      if ("^" === i.charAt(0) && /^\^\d+/.test(i)) {
                                          var a = 1;
                                          (a += (i = /\d+/.exec(i)[0]).length), (r = parseInt(i)), (e.temporaryPause = !0), e.options.onTypingPaused(e.arrayPos, e), (t = t.substring(0, n) + t.substring(n + a)), e.toggleBlinking(!0);
                                      }
                                      if ("`" === i.charAt(0)) {
                                          for (; "`" !== t.substring(n + o).charAt(0) && (o++, !(n + o > t.length)); );
                                          var c = t.substring(0, n),
                                              l = t.substring(c.length + 1, n + o),
                                              s = t.substring(n + o + 1);
                                          (t = c + l + s), o--;
                                      }
                                      e.timeout = setTimeout(function () {
                                          e.toggleBlinking(!1), n >= t.length ? e.doneTyping(t, n) : e.keepTyping(t, n, o), e.temporaryPause && ((e.temporaryPause = !1), e.options.onTypingResumed(e.arrayPos, e));
                                      }, r);
                                  }, r))
                                : this.setPauseStatus(t, n, !0);
                        }),
                        (n.keepTyping = function (t, n, e) {
                            0 === n && (this.toggleBlinking(!1), this.options.preStringTyped(this.arrayPos, this));
                            var r = t.substring(0, (n += e));
                            this.replaceText(r), this.typewrite(t, n);
                        }),
                        (n.doneTyping = function (t, n) {
                            var e = this;
                        ...
                        (n.backspace = function (t, n) {
                            ...
                            if (!0 !== this.pause.status) {
                                ...
                                this.timeout = setTimeout(function () {
                                    n = Ie.backSpaceHtmlChars(t, n, e);
                                    var r = t.substring(0, n);
                                    if ((e.replaceText(r), e.smartBackspace)) {
                                        var o = e.strings[e.arrayPos + 1];
                                        e.stopNum = o && r === o.substring(0, n) ? n : 0;
                                    }
                                    n > e.stopNum
                                        ? (n--, e.backspace(t, n))
                                        : n <= e.stopNum &&
                                          (e.arrayPos++, e.arrayPos === e.strings.length ? ((e.arrayPos = 0), e.options.onLastStringBackspaced(), e.shuffleStringsIfNeeded(), e.begin()) : e.typewrite(e.strings[e.sequence[e.arrayPos]], n));
                                }, r);
                            } else this.setPauseStatus(t, n, !1);
                        }),
                        (n.complete = function () {
                            this.options.onComplete(this), this.loop ? this.curLoop++ : (this.typingComplete = !0);
                        }),
                        (n.setPauseStatus = function (t, n, e) {
                            (this.pause.typewrite = e), (this.pause.curString = t), (this.pause.curStrPos = n);
                        }),
                        (n.toggleBlinking = function (t) {
                            this.cursor && (this.pause.status || (this.cursorBlinking !== t && ((this.cursorBlinking = t), t ? this.cursor.classList.add("typed-cursor--blink") : this.cursor.classList.remove("typed-cursor--blink"))));
                        }),
                        (n.humanizer = function (t) {
                        ...
                        (n.bindFocusEvents = function () {
                            var t = this;
                            this.isInput &&
                                (this.el.addEventListener("focus", function (n) {
                                    t.stop();
                                }),
                                this.el.addEventListener("blur", function (n) {
            ...
            function Ae(t) {
                for (var n = 1; n < arguments.length; n++) {
                    var e = null != arguments[n] ? arguments[n] : {};
                    n % 2
                        ? Oe(Object(e), !0).forEach(function (n) {
                              Ve(t, n, e[n]);
                          })
                        : Object.getOwnPropertyDescriptors
                        ? Object.defineProperties(t, Object.getOwnPropertyDescriptors(e))
                        : Oe(Object(e)).forEach(function (n) {
                              Object.defineProperty(t, n, Object.getOwnPropertyDescriptor(e, n));
                          });
                }
                return t;
            ...
            var Ne = function (t) {
                var n = { width: 9, height: 9, margin: "5px 0px 0px 5px", borderRadius: "50%", backgroundColor: "#a3a1a1", opacity: 1, animation: "bouncing-loader 0.4s infinite alternate" };
                return React.createElement(
                    ...
                    React.createElement(
                        "div",
                        { style: { display: "flex", justifyContent: "center", alignItems: "center", width: "100%", height: 26 } },
                        ["0.1s", "0.2s", "0.3s"].map(function (t, e) {
                            return React.createElement("div", { key: e, style: Ae(Ae({}, n), {}, { animationDelay: t }) });
                        })
                    )
                );
            };
            ...
            var He = (function () {
                    function t() {
                        if (
                            ...
                            return t.instance;
                        (this.chatbots = []), (this.filters = {}), (this.actions = {}), (t.instance = this), "undefined" != typeof window && (window.MwaiAPI = t.instance);
                    }
                    var n, e;
                    return (
                        (n = t),
                        (e = [
                            ...
                            },
                            {
                                ...
                                value: function (t, n) {
                                    ...
                                    this.filters[t] || (this.filters[t] = []),
                                        this.filters[t].push({ callback: n, priority: e }),
                                        this.filters[t].sort(function (t, n) {
                            ...
                            },
                            {
                                ...
                                value: function (t, n) {
                                    ...
                                    return this.filters[t]
                                        ? this.filters[t].reduce(function (t, n) {
                                              return n.callback.apply(n, [t].concat(r));
                                          }, n)
                                        : n;
                                },
                            },
                            {
                                ...
                                value: function (t, n) {
                                    ...
                                    this.actions[t] || (this.actions[t] = []),
                                        this.actions[t].push({ callback: n, priority: e }),
                                        this.actions[t].sort(function (t, n) {
                                            return t.priority - n.priority;
                                        });
                                },
                            },
                            {
                                ...
                                value: function (t) {
                                    ...
                                    this.actions[t] &&
                                        this.actions[t].forEach(function (t) {
                ...
                Xe = function (t, n) {
                    for (var e = arguments.length, r = new Array(e > 2 ? e - 2 : 0), o = 2; o < e; o++) r[o - 2] = arguments[o];
                    return Ze.applyFilters.apply(Ze, [t, n].concat(r));
                };
            function Me(t, n) {
                return (
                    (function (t) {
                    ...
                    (function (t, n) {
                        if (t) {
                            ...
                            var e = Object.prototype.toString.call(t).slice(8, -1);
                            return "Object" === e && t.constructor && (e = t.constructor.name), "Map" === e || "Set" === e ? Array.from(t) : "Arguments" === e || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(e) ? Pe(t, n) : void 0;
                        }
                    })(t, n) ||
                    (function () {
                        throw new TypeError("Invalid attempt to destructure non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method.");
            ...
            var We = wp.element,
                ...
                qe = function (t) {
                    ...
                    return React.createElement(
                        "div",
                        {
                            className: e("mwai-copy-button", { "mwai-animate": o }),
                            onClick: function () {
                                try {
                        ...
                        React.createElement("div", { className: e("mwai-copy-button-one") }),
                        React.createElement("div", { className: e("mwai-copy-button-two") })
                    );
                },
                Fe = function (t) {
                    var n,
                        ...
                        p = "assistant" === e.role,
                        d = u ? c : p ? l : null,
                        f = Me(_e(e.isQuerying || e.isStreaming), 1)[0],
                        h = e.isQuerying,
                        m = e.isStreaming,
                        y = null !== (n = e.content) && void 0 !== n ? n : "";
                    (y.match(/```/g) || []).length % 2 != 0 ? (y += "\n```") : e.isStreaming && (y += "<BlinkingCursor />"),
                        Qe(
                            function () {
                                (f && (!f || h || m)) || o();
                            },
                    ...
                    var g = De(
                        function () {
                            return { overrides: { BlinkingCursor: { component: Pn }, a: { props: { target: "_blank" } } } };
                        },
                        [h, m, y]
                    );
                    return h || (m && !y)
                        ...
                        : React.createElement(
                              React.Fragment,
                              null,
                              React.createElement("span", { className: s("mwai-name") }, d),
                              React.createElement("span", { className: s("mwai-text") }, React.createElement("span", null, React.createElement(kn, { children: y, options: g }))),
                              a && React.createElement(qe, { content: e.content })
                          );
                },
                Ye = function (t) {
                    var n = t.message,
                        ...
                        s = "assistant" === n.role,
                        u = l ? i : s ? a : null,
                        p = Me(_e(null == n ? void 0 : n.images), 2),
                        d = p[0],
                        f = p[1];
                    return (
                        Qe(function () {
                        ...
                        n.isQuerying
                            ...
                            : React.createElement(
                                  React.Fragment,
                                  null,
                                  React.createElement("span", { className: c("mwai-name") }, u),
                                  React.createElement(
                                      "span",
                                                                ...
                                                                return (function (t) {
                                                                    f(function (n) {
                                                                        return n.map(function (n, e) {
                                                                            return e === t ? "https://via.placeholder.com/600?text=Image+Gone" : n;
                                                                        });
                                                                    });
                                                                })(n);
                                                            },
                ...
                Ge = function (t) {
                    var n = t.message,
                        ...
                        s = i.modCss,
                        u = ze(null),
                        p = Me(_e(n.isQuerying), 1)[0],
                        d = Me(_e(!n.isQuerying), 2),
                        f = d[0],
                        h = d[1],
                        m = Me(_e(!1), 2),
                        y = m[0],
                    ...
                    return (
                        (function (t, n) {
                            ...
                            200,
                            function () {
                                e.current && !y && (e.current.scrollTop = e.current.scrollHeight);
                            },
                            !f
                        ),
                        Qe(
                            ...
                            function () {
                                if (p) {
                                    if (u.current) {
                                        var t = {
                                                strings: [b],
                                                typeSpeed: Xe("typewriter_speed", 15),
                                                showCursor: !1,
                                                onComplete: function (t) {
                        ...
                        React.createElement(
                            React.Fragment,
                            null,
                            n.isQuerying && React.createElement(Ne, null),
                            !n.isQuerying && p && React.createElement(React.Fragment, null, React.createElement("span", { className: s("mwai-name") }, v), React.createElement("span", { className: s("mwai-text"), ref: u })),
                            !n.isQuerying &&
                                !p &&
                                React.createElement(React.Fragment, null, React.createElement("span", { className: s("mwai-name") }, v), React.createElement("span", { className: s("mwai-text") }, React.createElement(kn, null, b))),
                            f && a && React.createElement(qe, { content: b })
                        )
                    );
                };
            const Ue = function (t) {
                var n,
                    ...
                    a = o.modCss,
                    c = ze(),
                    l = a("mwai-reply", { "mwai-ai": "assistant" === e.role, "mwai-user": "user" === e.role, "mwai-system": "system" === e.role }),
                    s = (null == e || null === (n = e.images) || void 0 === n ? void 0 : n.length) > 0,
                    u = function () {
                        c.current &&
                            (e.isQuerying ||
                                ...
                                ("undefined" != typeof hljs &&
                                    ...
                                    c.current.querySelectorAll("pre code").forEach(function (t) {
                                        hljs.highlightElement(t),
                                            ["hljs", "hljs-title", "hljs-keyword", "hljs-string"].forEach(function (n) {
                                                t.querySelectorAll("." + n).forEach(function (t) {
                                                    t.classList.remove(n);
                                                    var e = a(n).split(" ");
                                                    e && e.length > 1 ? t.classList.add(e[1]) : console.warn("Could not find class for " + n);
                                                });
                                            });
                                    }))));
                    };
                return De(
                    function () {
                        return "user" === e.role
                            ? React.createElement("div", { ref: c, className: l }, React.createElement(Fe, { message: e }))
                            : "assistant" === e.role
                            ? s
                                ? React.createElement("div", { ref: c, className: l }, React.createElement(Ye, { message: e, conversationRef: r, onRendered: u }))
                                : i && !e.isStreaming
                                ? React.createElement("div", { ref: c, className: l }, React.createElement(Ge, { message: e, conversationRef: r, onRendered: u }))
                                : React.createElement("div", { ref: c, className: l }, React.createElement(Fe, { message: e, conversationRef: r, onRendered: u }))
                            : "system" === e.role
                            ? React.createElement("div", { ref: c, className: l }, React.createElement(Fe, { message: e, conversationRef: r, onRendered: u }))
            ...
            function $e(t) {
                for (var n = 1; n < arguments.length; n++) {
                    var e = null != arguments[n] ? arguments[n] : {};
                    n % 2
                        ? Je(Object(e), !0).forEach(function (n) {
                              tr(t, n, e[n]);
                          })
                        : Object.getOwnPropertyDescriptors
                        ? Object.defineProperties(t, Object.getOwnPropertyDescriptors(e))
                        : Je(Object(e)).forEach(function (n) {
                              Object.defineProperty(t, n, Object.getOwnPropertyDescriptor(e, n));
                          });
                }
                return t;
                ...
                function w(t, n) {
                    function o(r, i, a, c) {
                        ...
                        if ("throw" !== l.type) {
                            var s = l.arg,
                                p = s.value;
                            return p && "object" == Ke(p) && e.call(p, "__await")
                                ? n.resolve(p.__await).then(
                                      function (t) {
                                          o("next", t, a, c);
                                      },
            ...
            function ir(t, n) {
                if (t) {
                    if ("string" == typeof t) return ar(t, n);
                    var e = Object.prototype.toString.call(t).slice(8, -1);
                    return "Object" === e && t.constructor && (e = t.constructor.name), "Map" === e || "Set" === e ? Array.from(t) : "Arguments" === e || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(e) ? ar(t, n) : void 0;
                }
            }
            function ar(t, n) {
                (null == n || n > t.length) && (n = t.length);
            ...
            const fr = function (t) {
                    var n = t.theme,
                                        ...
                                        if (null === r.current) {
                                            ...
                                            r.current = setInterval(function () {
                                                var n,
                                                    r,
                                                    o,
                                                    i = Math.floor((Date.now() - t) / 1e3);
                                                e(((n = i), (r = Math.floor(n / 60)), (o = n % 60), "".concat(r, ":").concat(o.toString().padStart(2, "0"))));
                                            }, 500);
                                        }
                                    },
                                    stopChrono: function () {
                        ...
                        g = sr(
                            function () {
                                return "css" === (null == n ? void 0 : n.type) ? (null == n ? void 0 : n.style) : null;
                            },
                            [n]
                        ),
                        v = dr(),
                        ...
                        V = C.messages,
                        N = C.inputText,
                        T = C.textInputMaxLength,
                        B = C.textSend,
                        H = C.textClear,
                        Z = C.textInputPlaceholder,
                        X = C.textCompliance,
                        M = C.isWindow,
                        P = C.fullscreen,
                        W = C.iconText,
                        ...
                        $ = (function (t) {
                            ...
                            return (
                                L(function () {
                                    "undefined" != typeof window && ("SpeechRecognition" in window || "webkitSpeechRecognition" in window) && a(!0);
                                }, []),
                                L(
                                    function () {
                                        if (i) {
                                            ...
                                            return (
                                                e ? (t.addEventListener("result", n), t.start()) : (t.removeEventListener("result", n), t.abort()),
                                                function () {
                                                    t.abort();
                                                }
                                            );
                                ...
                                { isListening: e, setIsListening: r, speechRecognitionAvailable: i }
                            );
                        })(),
                        tt = $.isListening,
                        nt = $.setIsListening,
                        et = $.speechRecognitionAvailable,
                        rt = dr(C);
                    ur(
                        function () {
                            rt.current = C;
                                            ...
                                            for (;;)
                                                switch ((t.prev = t.next)) {
                                                    case 0:
                                                        it.length > 0 &&
                                                            ("ask" === (n = it[0]).action
                                                                ? ((e = n.data), (r = e.text), e.submit ? G(r) : U(r))
                                                                : "toggle" === n.action
                                                                ? d(!p)
                                                                : "open" === n.action
                                                                ? d(!0)
                                                                ...
                                                                : "clear" === n.action
                                                                ? Y()
                                                                : "setContext" === n.action && ((o = n.data), (i = o.chatId), (a = o.messages), J(i), K(a)),
                                                            at(function (t) {
                                                                return t.slice(1);
                                                            }));
                                                    case 1:
                    ...
                    ur(
                        ...
                        ur(function () {
                            I &&
                                Ze.chatbots.push({
                                    ...
                                    open: function () {
                                        at(function (t) {
                                            return [].concat(nr(t), [{ action: "open" }]);
                                        });
                                    },
                                    close: function () {
                                        at(function (t) {
                                            return [].concat(nr(t), [{ action: "close" }]);
                                        });
                                    },
                                    clear: function () {
                                        at(function (t) {
                                            return [].concat(nr(t), [{ action: "clear" }]);
                                        });
                                    },
                                    toggle: function () {
                                        at(function (t) {
                                            return [].concat(nr(t), [{ action: "toggle" }]);
                                        });
                                    },
                                    ask: function (t) {
                                        var n = arguments.length > 1 && void 0 !== arguments[1] && arguments[1];
                                        at(function (e) {
                                            return [].concat(nr(e), [{ action: "ask", data: { text: t, submit: n } }]);
                                        });
                                    },
                                    setContext: function (t) {
                                        var n = t.chatId,
                                            e = t.messages;
                                        at(function (t) {
                                            return [].concat(nr(t), [{ action: "setContext", data: { chatId: n, messages: e } }]);
                                        });
                                    },
                                });
                        }, []),
                        ur(
                            function () {
                                q ? i() : (!j && w.current && v.current.focus(), a());
                            },
                            [q]
                        ),
                        ur(
                            function () {
                                !j && p && v.current.focus(), (b.current.scrollTop = b.current.scrollHeight);
                            },
                            [p]
                        ),
                        pr(
                    ...
                    var lt = function () {
                            var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : null;
                            (w.current = document.activeElement === v.current), t ? G(t) : N.length > 0 && G(N);
                        },
                        st = y("mwai-chat", { "mwai-window": M, "mwai-open": p, "mwai-fullscreen": !h || (!M && P), "mwai-bottom-left": "bottom-left" === D, "mwai-top-right": "top-right" === D, "mwai-top-left": "top-left" === D }),
                        ut = N.length < 1 && (null == V ? void 0 : V.length) > 1;
                    return React.createElement(
                        React.Fragment,
                        null,
                        React.createElement(
                            "div",
                            { id: "mwai-chatbot-".concat(I), className: st, style: $e($e({}, Q), e) },
                            ...
                            M &&
                                React.createElement(
                                    ...
                                    React.createElement(
                                        ...
                                        W && React.createElement("div", { className: y("mwai-icon-text") }, W),
                                        React.createElement("img", {
                                            width: "64",
                                            height: "64",
                                            alt: _,
                            ...
                            React.createElement(
                                ...
                                React.createElement(
                                    "div",
                                    { ref: b, className: y("mwai-conversation") },
                                    !!V &&
                                        V.map(function (t) {
                                            return React.createElement(Ue, { key: t.id, conversationRef: b, message: t });
                                        })
                                ),
                                React.createElement(
                                    "div",
                                    ...
                                    React.createElement(
                                        ...
                                        React.createElement(Re, {
                                            ...
                                            onKeyDown: function (t) {
                                                l || "Enter" !== t.code || t.shiftKey || (t.preventDefault(), t.stopPropagation(), lt());
                                            },
                                            onChange: function (t) {
                                                return (n = t.target.value), tt && nt(!1), void U(n);
                                                var n;
                                            },
                                        }),
                                        F &&
                                    ...
                                    q && React.createElement("button", { disabled: !0 }, o && React.createElement("div", { className: y("mwai-timer") }, o)),
                                    !q &&
                                        React.createElement(
                                            "button",
                                            {
                                            ...
                                            React.createElement("span", null, ut ? H : B)
                                        )
                                ),
                                X && React.createElement("div", { className: y("mwai-compliance"), dangerouslySetInnerHTML: { __html: X } })
                            )
                        )
                    );
                },
                hr = function (t) {
                    return React.createElement(se, t, React.createElement(fr, t));
                };
            function mr(t) {
                return (
                    (mr =
                ...
                function w(t, n) {
                    function o(r, i, a, c) {
                        ...
                        if ("throw" !== l.type) {
                            var s = l.arg,
                                p = s.value;
                            return p && "object" == mr(p) && e.call(p, "__await")
                                ? n.resolve(p.__await).then(
                                      function (t) {
                                          o("next", t, a, c);
                                      },
            ...
            function br(t) {
                for (var n = 1; n < arguments.length; n++) {
                    var e = null != arguments[n] ? arguments[n] : {};
                    n % 2
                        ? vr(Object(e), !0).forEach(function (n) {
                              wr(t, n, e[n]);
                          })
                        : Object.getOwnPropertyDescriptors
                        ? Object.defineProperties(t, Object.getOwnPropertyDescriptors(e))
                        : vr(Object(e)).forEach(function (n) {
                              Object.defineProperty(t, n, Object.getOwnPropertyDescriptor(e, n));
                          });
                }
                return t;
            ...
            function Rr(t, n) {
                return (
                    ...
                    (function (t, n) {
                        if (t) {
                            if ("string" == typeof t) return Cr(t, n);
                            var e = Object.prototype.toString.call(t).slice(8, -1);
                            return "Object" === e && t.constructor && (e = t.constructor.name), "Map" === e || "Set" === e ? Array.from(t) : "Arguments" === e || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(e) ? Cr(t, n) : void 0;
                        }
                    })(t, n) ||
                    (function () {
                        throw new TypeError("Invalid attempt to destructure non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method.");
            ...
            var kr = wp.element,
                ...
                Nr = function (t) {
                                                ...
                                                switch ((t.prev = t.next)) {
                                                    case 0:
                                                        return (
                                                            ...
                                                            n || m(!0),
                                                            (e = { botId: y }),
                                                            w && console.log("[DISCUSSIONS] OUT: ", e),
                                                            (t.next = 7),
                                                            fetch("".concat(b, "/mwai-ui/v1/discussions/list"), { method: "POST", headers: { "Content-Type": "application/json", "X-WP-Nonce": g }, body: JSON.stringify(e, Tn()) })
                                                        );
                                                    case 7:
                                                        return (r = t.sent), (t.next = 10), r.json();
                                                    case 10:
                                                        (o = t.sent),
                                                            w && console.log("[DISCUSSIONS] IN: ", o),
                                                            (i = o.chats.map(function (t) {
                                                                var n = JSON.parse(t.messages),
                                                                    e = JSON.parse(t.extra);
                                                                return br(br({}, t), {}, { messages: n, extra: e });
                                                            })),
                                                            s(i),
                                                            (t.next = 19);
                                                        break;
                                                    ...
                                                    case 19:
                                                        return (t.prev = 19), n || m(!1), t.finish(19);
                                                    case 22:
                                                    case "end":
                                                        return t.stop();
                                                }
                    ...
                    var R = function (t) {
                            var n = MwaiAPI.getChatbot(t);
                            if (!n) throw new Error("Chatbot not found.", { botId: t, chatbots: MwaiAPI.chatbots });
                            return n;
                        },
                        C = (function () {
                            var t = jr(
                                gr().mark(function t(n) {
                                    var e;
                                    return gr().wrap(function (t) {
                                        for (;;)
                                            switch ((t.prev = t.next)) {
                                                case 0:
                                                    if (
                                                    ...
                                                    return console.error("Discussion not found.", { chatId: n, discussions: l }), t.abrupt("return");
                                                case 4:
                                                    R(y).setContext({ chatId: n, messages: e.messages }), d(e);
                                                case 7:
                                                case "end":
                                                    return t.stop();
                                            }
                        ...
                        S = { onDiscussionClick: C, onNewChatClick: k },
                        I = { botId: y, pluginUrl: v, busy: h, setBusy: m, modCss: i, cssVariables: x, discussions: l, discussion: p, theme: o };
                    return React.createElement(Vr.Provider, { value: { state: I, actions: S } }, n);
                };
            function Tr(t) {
                return (
                    (Tr =
            ...
            function Hr(t) {
                for (var n = 1; n < arguments.length; n++) {
                    var e = null != arguments[n] ? arguments[n] : {};
                    n % 2
                        ? Br(Object(e), !0).forEach(function (n) {
                              Zr(t, n, e[n]);
                          })
                        : Object.getOwnPropertyDescriptors
                        ? Object.defineProperties(t, Object.getOwnPropertyDescriptors(e))
                        : Br(Object(e)).forEach(function (n) {
                              Object.defineProperty(t, n, Object.getOwnPropertyDescriptor(e, n));
                          });
                }
                return t;
            ...
            var Xr = wp.element,
                ...
                Wr = function (t) {
                    var n = t.discussion,
                        ...
                        c = n.messages,
                        l = c[c.length - 1],
                        s = l.content.length > 64 ? l.content.substring(0, 64) + "..." : l.content,
                        u = a("mwai-discussion", { "mwai-active": i });
                    return React.createElement("li", { className: u, onClick: r }, s);
                };
            const _r = function (t) {
                    var n = t.theme,
                        e = t.style,
                        ...
                        a = (function () {
                            var t = Sr(Vr);
                            if (!t) throw new Error("useDiscussionsContext must be used within a DiscussionsContextProvider");
                            return t;
                        })(),
                        c = a.state,
                        l = a.actions,
                    ...
                    return React.createElement(
                        ...
                        React.createElement(
                            "div",
                            { id: "mwai-discussions-".concat(s), className: g, style: Hr(Hr({}, u), e) },
                            ...
                            React.createElement(
                                ...
                                React.createElement(
                                    ...
                                    React.createElement("span", null, null != y ? y : "+ New chat")
                                )
                            ),
                            React.createElement(
                                "ul",
                                ...
                                p.map(function (t) {
                                    return React.createElement(Wr, {
                                        key: t.id,
                                        discussion: t,
                                        selected: (null == d ? void 0 : d.id) === t.id,
                                        modCss: o,
                                        onClick: function () {
                                            return h(t.chatId);
                                        },
                ...
                Dr = function (t) {
                    return React.createElement(Nr, t, React.createElement(_r, t));
                };
            var Qr = wp.element.render;
            function zr(t) {
            ...
            document.addEventListener("DOMContentLoaded", function () {
                function t(t, n) {
                    t.forEach(function (t) {
                        var e = JSON.parse(zr(t.getAttribute("data-params"))),
                            r = JSON.parse(zr(t.getAttribute("data-system"))),
                            o = JSON.parse(zr(t.getAttribute("data-theme")));
                        t.removeAttribute("data-params"), t.removeAttribute("data-system"), t.removeAttribute("data-theme"), Qr(n({ system: r, params: e, theme: o }), t);
                    });
                }
                t(document.querySelectorAll(".mwai-chatbot-container"), hr), t(document.querySelectorAll(".mwai-discussions-container"), Dr);
            });
        })();
})();
